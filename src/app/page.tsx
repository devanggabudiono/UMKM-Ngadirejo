...
export default function Home() {
  const umkmList = getAllUmkm();
  const stats = getUmkmStats();
  const categories = getKategoriList();
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-emerald-50/70 via-emerald-50/30 to-transparent pt-20 pb-24 md:pt-28 md:pb-32 border-b border-emerald-100/30">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-slate-900 tracking-tight max-w-4xl leading-[1.15] mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-emerald-700">Desa Ngadirejo</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-16 w-full sm:w-auto">
            <a href="#daftar-umkm" className="inline-flex items-center justify-center bg-emerald-600 hover:bg-emerald-700 text-white text-sm sm:text-base font-bold py-3 px-8 rounded-2xl transition-all duration-200 shadow-md shadow-emerald-200 hover:-translate-y-0.5">Cari UMKM</a>
            <a href="#peta-sebaran" className="inline-flex items-center justify-center bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 text-sm sm:text-base font-bold py-3 px-8 rounded-2xl transition-all duration-200 shadow-sm hover:-translate-y-0.5">Lihat Peta</a>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl w-full">
            <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow">
              <div className="bg-emerald-50 text-emerald-600 p-3.5 rounded-xl"><Store className="w-6 h-6" /></div>
            ...
            <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow">
              <div className="bg-emerald-50 text-emerald-600 p-3.5 rounded-xl"><ShoppingBag className="w-6 h-6" /></div>
              <div className="text-left">
                <div className="text-2xl font-black text-slate-950">{stats.totalKategori}</div>
                <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Jenis Usaha</div>
              </div>
            </div>
            <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow">
              <div className="bg-emerald-50 text-emerald-600 p-3.5 rounded-xl"><MapPin className="w-6 h-6" /></div>
              <div className="text-left">
